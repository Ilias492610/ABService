    ...
    <section className="bg-[#f5f7f9]">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-y-6 px-4 py-10 sm:px-6 md:py-[60px] lg:grid-cols-10 lg:gap-x-12 lg:px-8 lg:py-20">
        <div className="text-center lg:col-span-3 lg:text-left">
          <h6 className="text-xs font-semibold uppercase tracking-[0.1em] text-donkerblauw">
            Wettelijk verplicht in Antwerpen
          </h6>
        </div>
        <div className="lg:col-span-7">
          <h2 className="mb-6 text-[22px] font-bold leading-[1.3] text-[#1a1a2e] md:text-[26px] lg:text-[32px]">
            Verplichte keuring bij ingebruikname van uw cv-installatie in Antwerpen
          </h2>
          <p className="mb-6 text-base leading-relaxed text-[#5a6c7d]">
            Laat uw nieuwe of aangepaste cv-installatie keuren door onze erkende Antwerpse technici. U ontvangt een officieel keuringsrapport en verbrandingsattest, zodat u met een gerust hart kunt verwarmen.
          </p>
