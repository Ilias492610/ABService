  ...
  return (
    <section className="bg-[#e8ebed] py-16 md:py-20 lg:py-24" aria-labelledby="herstelling-hero-heading">
      <div className="mx-auto max-w-[1200px] px-6 text-center md:px-20">
        ...
        >
          Spoed herstelling door uw loodgieter en warmtespecialist in Antwerpen
        </h1>
        <p className="mt-4 text-base text-[#4a5d58] md:text-lg">
          Storingen worden snel opgelost door onze lokale loodgieters en warmtespecialisten zodat uw woning opnieuw warm en veilig is.
        </p>
      </div>
    </section>
  );
