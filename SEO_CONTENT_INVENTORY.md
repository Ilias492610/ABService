...
| `/herstelling` | Herstelling van verwarming en cv-ketel \| AB Service | Herstelling van cv-ketel en verwarming | Repair and safe triage | Index | Fault codes, maintenance, tariffs | Owner scope; conservative safety guidance |
...
| `/foutcodes` | Foutcodes van cv-ketels: veilige eerste stappen \| AB Service | Gebruik een foutcode als aanwijzing, niet als diagnose | Fault-code hub | Index | Vaillant, Bulex, contact | Manufacturer-link publication policy |
...
| `/foutcodes/bosch` | Bosch foutcodes: betekenis en veilige eerste stap | `noindex, follow` | No official model-linked code set in repository | Excluded |
| `/foutcodes/junkers` | Junkers foutcodes: betekenis en veilige eerste stap | `noindex, follow` | No official model-linked code set in repository | Excluded |
