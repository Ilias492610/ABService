...
export const calculateAreaPriorityScore = (signals) => {
  const factors = [
    ...
    "organicCompetitionOpportunity",
  ];
  if (factors.some((factor) => !Number.isFinite(signals[factor]))) return null;
  return factors.reduce((score, factor) => score + signals[factor], 0);
};
...
export const antwerpDistricts = Object.freeze([
  ...
  district("Berchem", {
    ...
    faq: ["Werkt AB Service in alle wijken van Berchem?", "Welke informatie is nuttig bij een appartement in Berchem?"],
  ...
  district("Berendrecht-Zandvliet-Lillo", {
    ...
    faq: ["Komt AB Service naar alle drie de kernen?", "Waarom vraagt AB Service vooraf extra locatiegegevens?"],
  ...
  district("Borgerhout", {
    ...
    faq: ["Kan ik een storing in Borgerhout met foto’s aanmelden?", "Wat als de hoofdkraan of technische ruimte gemeenschappelijk is?"],
  ...
  district("Borsbeek", {
    ...
    faq: ["Bedient AB Service Borsbeek sinds het een Antwerps district is?", "Welke locatiegegevens helpen bij de planning?"],
  ...
  district("Deurne", {
    ...
    faq: ["In welke delen van Deurne komt AB Service?", "Wat moet ik doorgeven bij een cv-storing in Deurne?"],
  ...
  district("Ekeren", {
    ...
    faq: ["Is heel Ekeren onderdeel van het werkgebied?", "Welke foto’s zijn nuttig voor een sanitaire aanvraag?"],
  ...
  district("Hoboken", {
    ...
    faq: ["Welke diensten zijn beschikbaar in Hoboken?", "Kan AB Service vooraf een prijs geven op basis van één foto?"],
  ...
  district("Merksem", {
    ...
    faq: ["Komt AB Service in alle wijken van Merksem?", "Wat als een installatie gedeeld wordt met andere bewoners?"],
  ...
  district("Wilrijk", {
    ...
    faq: ["Welke aanvragen behandelt AB Service in Wilrijk?", "Waarom is een offerte afhankelijk van de bestaande aansluiting?"],
