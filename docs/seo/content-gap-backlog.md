...
| Candidate | Current state | Evidence needed before publication | Priority after evidence |
|---|---|---|---:|
| First genuine project + `/projecten` hub | Draft | Complete project record, work proof, consent, authentic photos | 1 |
| Strongest real municipality page | Draft | Confirmed coverage, genuine local project, unique local guidance | 2 |
| Leak detection/repair | Draft | Active scope, tools/method limits, authentic job evidence | 2 |
| Drain unblocking | Draft | Active scope, equipment, exclusion policy, real work evidence | 3 |
| Boiler service/install | Draft | Exact product/service scope and case evidence | 3 |
